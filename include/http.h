...
typedef enum {
    ...
    HTTP_ERROR_NOT_ENABLED =  TIZEN_ERROR_HTTP|0x0501,  /**< Not enabled */
    HTTP_ERROR_OPERATION_FAILED = TIZEN_ERROR_HTTP|0x0502,  /**< Operation failed */
 ...
 * @since_tizen 3.0
 * @param[in]  transaction The http transaction handle
 ...
 */
typedef void (*http_transaction_progress_cb)(http_transaction_h transaction, double download_total, double download_now, double upload_total, double upload_now, void *user_data);
...
/**
 * @brief Creates the Http Session.
 * @since_tizen 3.0
 ...
 * @since_tizen 3.0
 * @param[in]  http_session 	The http session handle
 * @param[in]  auto_redirection	The value which determines whetehr allow redirection or not
 * @return 0 on success, otherwise negative error value
 * @retval  #HTTP_ERROR_NONE  Successful
 * @retval  #HTTP_ERROR_INVALID_PARAMETER  Invalid parameter
...
/**
 * @brief Closes the Http Transaction.
 * @since_tizen 3.0
 * @param[in]  http_transaction  The http transaction handle
 * @return 0 on success, otherwise negative error value
 * @retval  #HTTP_ERROR_NONE  Successful
 * @retval  #HTTP_ERROR_INVALID_PARAMETER  Invalid parameter
 * @see		http_open_transaction()
 */
 ...
 * @since_tizen 3.0
 * @param[in]  http_transaction  The http transaction handle
 * @param[in]  pause_state		 The pause state of the connection
 * @return 0 on success, otherwise negative error value
 * @retval  #HTTP_ERROR_NONE  Successful
 * @retval  #HTTP_ERROR_INVALID_PARAMETER  Invalid parameter
 * @retval  #HTTP_ERROR_OPERATION_FAILED  Operation failed
 ...
 * @details The verify determines whetehr verifies the peer's certificate.
 * @since_tizen 3.0
 * @param[in]  http_transaction  The http transaction handle
 ...
 * @details Set an HTTP meethod such as GET, POST, PUT and etc.
 * @since_tizen 3.0
 * @param[in]  http_transaction  The http transaction handle
 ...
 * @details The Accept-Encoding header enables automatic decompressino of HTTP downloads.
 * @since_tizen 3.0
 * @param[in]  http_transaction The http transaction handle
 ...
 * @since_tizen 3.0
 * @remarks  The foramt of string should be NME=CONTENTS (e.g. "name1=hello; name2=tizen;")
 * @param[in]  http_transaction The http transaction handle
