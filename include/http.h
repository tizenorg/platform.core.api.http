 ...
 */
typedef void (*http_transaction_aborted_cb)(http_transaction_h http_transaction, int reason, void *user_data);
 ...
 */
/**
 * @brief Creates http transaction handle.
 * @since_tizen 3.0
 ...
 * @retval  #HTTP_ERROR_NONE  Successful
 * @retval  #HTTP_ERROR_INVALID_PARAMETER  Invalid parameter
 * @see		http_transaction_destroy()
 */
int http_transaction_create(http_method_e method, http_transaction_h *http_transaction);
 ...
 * @retval  #HTTP_ERROR_INVALID_PARAMETER  Invalid parameter
 */
int http_transaction_open(http_transaction_h http_transaction, http_session_h http_session);
