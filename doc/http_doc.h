 ...
 * @brief The HTTP API provies functions for  .
 *
 * @section CAPI_NETWORK_HTTP_MODULE_HEADER Required Header
 *   \#include <http.h>
 *
 * @section CAPI_NETWORK_HTTP_MODULE Overview
 * The HTTP API provides functions for transfering HTTP request to server and receiving HTTP response from server.
 * It also helps application to write HTTP message and get 
 * 
 * @section CAPI_NETWORK_HTTP_MODULE_FEATURE Related Features
 * This API is related with the following features:\n
 * - http://tizen.org/feature/http\n
 *
