...
API int http_transaction_create(http_method_e method, http_transaction_h *http_transaction)
{
...
API int http_transaction_open(http_transaction_h http_transaction, http_session_h http_session)
{
