...
API int http_open_authentication(http_transaction_h http_transaction, http_transaction_h *http_auth_transaction)
{
	...
	auth_transaction->header_cb = transaction->header_cb;
	auth_transaction->header_user_data = transaction->header_user_data;
	auth_transaction->body_cb = transaction->body_cb;
	auth_transaction->body_user_data = transaction->body_user_data;
	auth_transaction->write_cb = transaction->write_cb;
	auth_transaction->write_user_data = transaction->write_user_data;
	auth_transaction->completed_cb = transaction->completed_cb;
	auth_transaction->completed_user_data = transaction->completed_user_data;
	auth_transaction->aborted_cb = transaction->aborted_cb;
	auth_transaction->progress_cb = transaction->progress_cb;
	auth_transaction->progress_user_data = transaction->progress_user_data;
